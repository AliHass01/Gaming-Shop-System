public class PublicRoom extends GamingShop{

   private int PricePerHour=2;

    public PublicRoom(String name, int number , int age , double numberOfHours, TypeOfDevice typeOfDevice){
    ...
    public  double Discount(){
         if (Number>=5){
             return ((NumberOfHours*Number*PricePerHour)*0.05);
         }else
             return 0;
    }
    @Override
